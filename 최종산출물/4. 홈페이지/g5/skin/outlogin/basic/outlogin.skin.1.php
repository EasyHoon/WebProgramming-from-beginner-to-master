...
<section id="ol_before" class="ol">
	...
	<div class='ol_top'>
		<div class='ol_join'><a href="javascript:;" onclick="javascript:window.open('<?php echo G5_BBS_URL ?>/register.php','cnjOpen','width=730,height=760, left=400, top=100')">회원가입</a></div>
